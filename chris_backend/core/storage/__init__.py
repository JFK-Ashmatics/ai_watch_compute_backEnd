...
Examples include OpenStack Swift object storage, AWS S3, Azure Data Lake Storage Gen2 (ADLS Gen2),
MinIO, Ceph RGW, or of course, a literal UNIX-y filesystem.
...
from .azure_datalake_manager import AzureDataLakeManager
from .plain_fs import FilesystemManager
from .helpers import connect_storage, verify_storage_connection


__all__ = ['StorageManager', 'SwiftManager', 'S3Manager', 'AzureDataLakeManager',
           'FilesystemManager', 'connect_storage', 'verify_storage_connection']
